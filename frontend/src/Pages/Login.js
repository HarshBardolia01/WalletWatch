          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} textAlign={"center"}>
              <Button
                ...
                disabled={!validEmail || userInfo.email.length == 0}
              >
                Login
              </Button>
            </Grid>
          ...
          <Box>
            <Grid container spacing={2}>
              ...
              <Grid item xs={3} textAlign={"center"}>
                <Button
                  variant={userInfo.otp === otps[0] ? "contained" : "outlined"}
                  value={otps[0]}
              ...
              <Grid item xs={3} textAlign={"center"}>
                <Button
                  variant={userInfo.otp === otps[1] ? "contained" : "outlined"}
                  value={otps[1]}
                  onClick={handleSelectOTP}
                >
                  {otps[1]}
              ...
              <Grid item xs={3} textAlign={"center"}>
                <Button
                  variant={userInfo.otp === otps[2] ? "contained" : "outlined"}
                  value={otps[2]}
                  onClick={handleSelectOTP}
                >
                  {otps[2]}
              ...
              <Grid item xs={3} textAlign={"center"}>
                <Button
                  variant={userInfo.otp === otps[3] ? "contained" : "outlined"}
                  value={otps[3]}
                  onClick={handleSelectOTP}
                >
                  {otps[3]}
